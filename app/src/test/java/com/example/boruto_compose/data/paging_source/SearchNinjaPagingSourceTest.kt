...
import com.example.boruto_compose.data.data_source.remote.FakeBorutoRemoteDataSource
...
class SearchNinjaPagingSourceTest {
    ...
    @Before
    fun setUp() {
        borutoRemoteDataSource = FakeBorutoRemoteDataSource()
        ninjas = listOf(
                Ninja(
                    id = 1,
                    name = "Sasuke",
